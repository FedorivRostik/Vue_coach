<template>
    <header class="mx-auto w-full  py-2 px-6 bg-green-600 text-white">
        <nav class="flex max-w-6xl mx-auto items-center justify-between">
            <h1 class=" font-extrabold text-2xl"><router-link to="/">Find a coach</router-link></h1>
